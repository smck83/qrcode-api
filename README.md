...
| EXPAND_HOSTNAMES | No | Default `False` : When set to `True` top level hostnames will be included from `ALLOWED_HOSTNAMES`, e.g. When `True` and https://host3.host2.host1.com/abc123 will check `ALLOWED_HOSTNAMES` for host3.host2.host1.com and also TLD, host1.com|
