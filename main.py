...
if 'AUTH_KEYS' in os.environ:  # Auth key allows QR Code to be generated by appending authkey=<key> to the GET request and override ALLOWED_HOSTNAME
    authList = (os.environ['AUTH_KEYS']).lower().split(' ')
else:
    import uuid
    defaultAuthKey = str(uuid.uuid4())
    print("Default auth key:",defaultAuthKey)
    authList = [defaultAuthKey] # default authKey
...
def generate(message,authKey = None,short: bool = 1):
